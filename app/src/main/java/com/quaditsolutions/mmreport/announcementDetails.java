...
public class announcementDetails extends AppCompatActivity {
    ...
    RecyclerViewAnnouncementDetailsAdapter rvAnnouncementList;
    SwipeRefreshLayout mSwipeRefreshLayout;

    String userCode, companyCode, storeLocation, TAG = "TAG", sAnnID = "", sAnnTitle = "", currentIPAddress;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        b = new ProgressDialog(announcementDetails.this);
        ...
        rvAnnouncementList = new RecyclerViewAnnouncementDetailsAdapter(getDataAdapter, this);
        recyclerView.setAdapter(rvAnnouncementList);

        // get announcement data
        Intent getIntent = getIntent();
        sAnnID = getIntent.getStringExtra("annID");
        sAnnTitle = getIntent.getStringExtra("annTitle");
    ...
    private void getItemData() {
        try {
            ...
            cursor = sqlDB.rawQuery("SELECT " +
                    ...
                    "announceDateCreated " +
                    "FROM announcement " +
                    "WHERE announceID = '" + sAnnID + "' " +
                    "AND announceTitle = '" + sAnnTitle + "' ", null);

            if (cursor.getCount() == 0) {

                Toast.makeText(announcementDetails.this, "No Item Found.", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            try {
                if (resultAnnouncement.toString().equals("failed")) {
                    Toast.makeText(announcementDetails.this, "No Announcement Found.", Toast.LENGTH_SHORT).show();
                } else {
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(announcementDetails.this, "loading...", Toast.LENGTH_SHORT).show();
                            }
                        });
