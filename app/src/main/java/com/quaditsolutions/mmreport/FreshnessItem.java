...
public class FreshnessItem extends AppCompatActivity {

    RecyclerView recyclerView;
    RecyclerView.LayoutManager recyclerViewlayoutManager;
    RecyclerView.Adapter recyclerViewadapter;
    private RecyclerViewItemCategoryForFreshness sAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freshness_item);
        ...
        sAdapter = new RecyclerViewItemCategoryForFreshness(GetDataAdapter1, this);
    ...
    private void checkStoreLocCode() {
        try {
            ...
            if (chkStoreLocCode.equals("")) {
                ...
                mExit.setMessage("Please Time In first to start Freshness.");
    ...
    private void checkWeekNo(String userCode) {
        ...
        if (cursor.getCount() == 0 || cursor.equals(null)) {
            ...
            if (cursor.moveToFirst()) {
                ...
                editor.putString("weekNoFreshness", cursor.getString(0));
                editor.apply();
            }
        }
        sqlDB.close();
    ...
    private void alertDialog() {
        ...
        AlertDialog.Builder mExit = new AlertDialog.Builder(this);
        mExit.setTitle("Start Freshness");
        mExit.setMessage("Do you want to start recording for this week?");
        mExit.setCancelable(false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        startActivity(new Intent(FreshnessItem.this, MainActivity.class));
        finish();
