...
public class RecyclerViewFreshnessItem extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewFreshnessItem(List<GlobalVar> getDataAdapter, Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerViewFreshnessItem.MyHolder holder=new RecyclerViewFreshnessItem.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder  holder, int position) {
        RecyclerViewFreshnessItem.MyHolder myHolder= (RecyclerViewFreshnessItem.MyHolder) holder;
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            in.putExtra("itemCodeFresh", itemCode);
            in.putExtra("itemNameFresh", itemName);
