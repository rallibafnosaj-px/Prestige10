...
public class RequestOvertimeTab extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        getItemData();
        recyclerViewadapter = new RecyclerViewForOvertimeRequest(GetDataAdapter1,getActivity());
        ...
        try {
            ...
            if(cursor.moveToFirst())
            {
                do
                {
                    ...
                    globalVar.reqotStoreName = cursor.getString(0);
                    globalVar.reqotDateIn = cursor.getString(1);
                    globalVar.reqotDateOut = cursor.getString(2);
                    globalVar.reqotTimeIn = cursor.getString(3);
                    globalVar.reqotTimeOut = cursor.getString(4);
                    globalVar.reqotStatus = cursor.getString(5);
