...
public class RecyclerViewOSACategory extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewOSACategory(List<GlobalVar> getDataAdapter, Context context){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        RecyclerViewOSACategory.MyHolder holder=new RecyclerViewOSACategory.MyHolder(view);
        return holder;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder  holder, int position) {
        ...
        RecyclerViewOSACategory.MyHolder myHolder= (RecyclerViewOSACategory.MyHolder) holder;
    ...
    class MyHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            Intent in = new Intent(itemView.getContext(), OSAItemActivity.class);
            //in.putExtra("itemCode", itemCode);
            in.putExtra("categoryNameOSA", categoryName);
