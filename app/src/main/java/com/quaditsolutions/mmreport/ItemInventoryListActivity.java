...
public class ItemInventoryListActivity extends AppCompatActivity {
    ...
    private void getItemQry() {
        try{
            ...
            if (cursor.getCount() > 0) {
                ...
                AlertDialog.Builder b = new AlertDialog.Builder(ItemInventoryListActivity.this);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        Intent i = new Intent(ItemInventoryListActivity.this, ItemCategoryActivity.class);
